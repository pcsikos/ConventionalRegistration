...
#pragma warning disable RECS0001 // Class is declared partial but has only one part
        ...
        namespace ConventionalRegistration.Tests.Diagnostics
        {
            [TestClass]
        ...
        namespace ConventionalRegistration.Tests.Configuration
        {
            [TestClass]
        ...
        namespace ConventionalRegistration.Tests.TypeFiltering
        {
            ...
            public partial class TypeSelectorTests
            {
                ...
                [TestCategory("UnitTestGenerator.ArgumentCheck")]
                [ExpectedException(typeof(System.ArgumentNullException))]
                public void IsImplementingGenericTypes_GenericTypeDefinitionsNullValueGiven_ShouldThrowArgumentNullException()
                {
                    var typeSelector = ProxyGenerator.CreateProxy<TypeSelector>();		 
                    typeSelector.IsImplementingGenericTypes(null);		 
                }

                [TestMethod]
                [TestCategory("UnitTestGenerator.ArgumentCheck")]
                [ExpectedException(typeof(System.ArgumentNullException))]
                public void IsNotImplementingGenericTypes_GenericTypeDefinitionsNullValueGiven_ShouldThrowArgumentNullException()
                {
                    var typeSelector = ProxyGenerator.CreateProxy<TypeSelector>();		 
                    typeSelector.IsNotImplementingGenericTypes(null);		 
                }
        ...
        namespace ConventionalRegistration.Tests.RegistrationProducers
        {
            [TestClass]
