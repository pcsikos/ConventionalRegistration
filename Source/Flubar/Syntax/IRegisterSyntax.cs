...
namespace Flubar.Syntax
{
    public interface IRegisterSyntax
    {
        ...
        void RegisterEach(Action<IRegistrationEntry, ITypeExclusionTracker> handleRegistration);
        ...
        void RegisterAll(Action<IEnumerable<IRegistrationEntry>, ITypeExclusionTracker> handleRegistration);
    }
}
