...
namespace Flubar
{
    ...
    //    IConfigurationServiceExclusion Exclude(Type serviceType, Type implementation = null);
    //    IConfigurationServiceExclusion Exclude(IEnumerable<Type> serviceTypes, Type implementation = null);
    //}
}
